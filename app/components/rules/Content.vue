<template>
	<div>
		...
		<section>
			...
			<ul>
				<li>
					...
					format will be used. Showers need to provide a 3x5 index card for each
					entry in each class. Because most of the classes are being
					concurrently judged for Breed and Collectibility/Workmanship, it is
					helpful for the judges if you can use a
					<strong>white 3x5 card</strong> for breed halter classes and a
					<strong>colored 3x5 card</strong> for Collectibility/Workmanship
					classes.
				</li>
				<li>
				...
				<li>
					...
					limits in Performance, Hartlands and Medallions.
				</li>
				...
				<li>
					<strong>Decisions of the judges are final!</strong> Please do not
					question them while they are judging a class. If you have a question
					regarding a placing, please ask the judge politely and promptly after
					the class.
				</li>
				...
				<li>
					...
					behavior or language, or exhibiting poor sportsmanship, will be asked
					to leave the show hall with no refund.
				</li>
				<li>
					Please <strong>do not hover</strong> while the judge is judging a
					class! Likewise, please refrain from interrupting the judges while
					they are judging a class.
				</li>
				<li>
					<strong>Do not touch</strong> any models other than your own unless
					you have the specific permission of the owner. Please avoid bumping
					any tables.
				</li>
				<li>
				...
				<li>
					<strong>NO SMOKING</strong> in the building. You may smoke outside,
					away from the door, as long as you properly dispose of the butts.
				</li>
				<li><strong>NO ALCOHOLIC BEVERAGES</strong> on the premises.</li>
				<li>Section Championships will be held to determine Championships and Reserves of each division. Please bring all horses winning first or second place to the table when the division championship is called. Division Champions and Reserves will be called back for the Overall Championship at the end of each day.</li>
				<li>No pets in the show hall unless they are a documented service animal. Documented service animals must be under control <strong>at all times.</strong></li>
				<li>Please keep talking at a low volume and listen for all announcements! Please realize we cannot delay the show for failure to heed class calls.</li>
				<li><strong>Pick up your models promptly at the end of each class.</strong> Failure to be prompt removing your models causes serious delays in the show and is unfair to all. Please realize that you should only show the quantity of models that allows you to keep up with the pace of the show. Thank you!</li>
			</ul>
			<p class="mt-12 text-lg md:text-xl w-full">Questions? Please ask the judge or the show-holder.</p>
			</div>
		</section>
		...
		<!-- <section>
			...
			<ul class="show-rules">
				<li>
					If you want to show more than 3 (or 4 in defined) horses in any class,
					you can if there is room. It will cost you $1.00 per horse.
				</li>
			</ul>
		</section> -->
		<!-- DOCUMENTATION -->
